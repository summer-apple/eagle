	...
	<div class="page-container">
		...
		<div class="main-content">
			...
			<div class="title-env">
					...
					<p class="description">query and create new facilities</p>
				</div>
				...
				<div class="breadcrumb-env">
					...
					<ol class="breadcrumb bc-1">
						...
						<li class="active"><strong>设施</strong></li>
					</ol>
...
<!--主体部分开始-->
			...
			<div class="panel panel-default">
				...
				<div class="row">
					...
					<div class="col-sm-2">
						<a href="javascript:;" onclick="jQuery('#modal-6').modal('show', {backdrop: 'static'});" class="btn btn-primary btn-single btn-sm">新建设施</a>
					</div>
				</div>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-header">
					...
					<h4 class="modal-title">新增-编辑 设施</h4>
				</div>
				...
				<form id="add-form" role="form" class="form-horizontal" action="" method="post">
					...
					<div class="row">
						<div class="col-md-6">
							...
							<div class="form-group">
								<label for="content" class="control-label">设施名称</label>
						...
						<div class="col-md-4">
							<div class="form-group">
								<label for="type" class="control-label">设施类型</label>
...
//删除
	...
	window.del = function(id){
		$.ajax({
                url:'facility/delFacility?id='+id,
                type:'post',
                dataType:'json',
                success:function(data){
                	if (data==true) {
